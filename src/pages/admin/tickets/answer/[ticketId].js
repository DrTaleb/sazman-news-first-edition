...
export default function Answer() {
    ...
    return (
        <>
            <div className={"container"}>
                <div className={"d-flex flex-column gap-3"}>
                    <div className={"d-flex flex-row gap-2"}>
                        ...
                        <div className={"chat-item text-justify bg-white rounded-3 py-3 px-3 shadow-sm"}>
            ...
            <div className={"chat-text-input shadow-lg"}>
                <div className={"d-flex flex-row h-100"}>
                    <Tooltip title={"پشتیبانی وبسایت"}>
                        <div className={"company-profile-img align-self-center mx-4"}>
                            <img alt={""} src={"/img/consulting.svg"} className={"w-100"}/>
                        </div>
                    </Tooltip>
                    <TextField
